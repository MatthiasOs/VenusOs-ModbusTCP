...
/**
 * Unterstützte Modbus Operationen nach dem Excel Sheet:
...
public class ModbusOperation {
	...
	public static final ModbusOperation ACTIVE_INPUT_SOURCE = new ModbusOperation(826, "Active input source", 1, DBusUnit.SOURCE, Range.between(0, 32668));
	...
	public static final ModbusOperation BATTERY_CURRENT_SYSTEM = new ModbusOperation(841, "Battery Current (System)", 10, DBusUnit.V_DC, Range.between(-32668, 32668));
	public static final ModbusOperation BATTERY_POWER_SYSTEM = new ModbusOperation(842, "Battery Power (System)", 1, DBusUnit.W, Range.between(-32668, 32668));
