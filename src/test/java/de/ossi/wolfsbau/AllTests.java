...
import de.ossi.wolfsbau.modbus.RegisterZuWertUmwandlerTest;
import de.ossi.wolfsbau.parser.WRAntwortParserTest;

@RunWith(Suite.class)
@SuiteClasses({ WRAntwortParserTest.class, DBModelTest.class, WRAnfragerTest.class, EnumPairTest.class, XMLtoDBConverterTest.class, RegisterZuWertUmwandlerTest.class })
